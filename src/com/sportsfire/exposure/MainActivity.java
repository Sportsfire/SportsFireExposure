...
public class MainActivity extends ListActivity {
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		switch (position) {
		case 0:
			myIntent = new Intent(MainActivity.this, SportsFireExposure.class);
			break;

		case 1:
			myIntent = new Intent(MainActivity.this, About.class);
			break;

		case 2:
			myIntent = new Intent(MainActivity.this, Quit.class);
			break;
